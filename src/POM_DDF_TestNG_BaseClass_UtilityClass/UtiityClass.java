...
public class UtiityClass {
	...
	//Automation TE: Viraj
		...
		public static String getDatafromPF(String key) throws IOException 
		{
			...
			FileInputStream file=new FileInputStream("C:\\Users\\Shree\\eclipse-workspace\\6 Aug Mornning a selanium\\propertyFile.properties");
		...
		public static void CaptureScreenshot(WebDriver driver, int TestCaseID) throws IOException
		{
			...
			System.out.println(Source);
			                                                      ...
			                                                      //101
			File Destination=new File("D:\\Baliraj\\Baliraj SW TESTING\\Notes\\automation\\TakesScreenshot\\."+TestCaseID+".jpg");
